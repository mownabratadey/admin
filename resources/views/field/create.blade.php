                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('field.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="label" type="text" class="form-control @error('label') is-invalid @enderror" name="label" value="{{ old('label') }}" required autocomplete="label">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="field_name" type="text" class="form-control @error('field_name') is-invalid @enderror" name="field_name" value="{{ old('field_name') }}" required autocomplete="field_name">
